...
public class ThrowBombUp extends PowerUp {
    /**
     ...
     */
    public ThrowBombUp(GameFrame frame, int X, int Y) {
        super(frame, X, Y);
    }
    ...
    public void performBonus() {
        frame.player.increaseThrowBomb();
    }

    @Override
    protected ArrayList<Image> getImageNullList() {
        return getMain().graphicsContainer.powerUpThrowBombImages;
    }
}
